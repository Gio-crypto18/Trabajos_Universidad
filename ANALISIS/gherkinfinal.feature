...
# Como estudiante en prácticas, quiero tener la opción de poder ajustar el nivel de dificultad para que pueda adaptarme eficazmente a las situaciones planteadas.
       Scenario:  Selección de nivel de dificultad.
                 Given que soy un “<estudiante>” en prácticas
                  And quiero adaptar las simulaciones a mi nivel de habilidad actual,
                  When inicie una “<simulaciones>” en la plataforma,
                   | estudiante | simulación   | seleccionar |
                   | Juan        | Simulación A | intermedio | 
                   | María       | Simulación B | avanzado   |
Then podré “<seleccionar>” el nivel de dificultad “<basico>”,“<intermedio>”,“<avanzado>”antes de comenzar, permitiéndole enfrentar situaciones que correspondan a mi nivel de experiencia.
...
# Como estudiante en prácticas, quiero tener la opción de poder ajustar el nivel de dificultad para que pueda adaptarme eficazmente a las situaciones planteadas.
       Scenario:  Ajuste de la dificultad durante la simulación
                 Given que soy un “<estudiante>” en prácticas 
                 And necesito que las “<simulaciones>” se adapten a mi “<rendimiento>”,
                 When esté participando en una “<simulación>”  en tiempo real,
Then la plataforma ajustará dinámicamente el nivel de dificultad en función de              mis respuestas 
...
And  proporciona simulaciones de acuerdo al “<rendimiento académico>” en el que me encuentro.
...
#lenguaje: es 
Feature:  Realizar simulaciones 
#Como estudiante en prácticas, quiero realizar simulaciones en VR para que pueda mejorar constantemente cada día.
       Scenario: Acceso a simulaciones. 
                  Given que soy un “<estudiante en prácticas>”
     ...
     | María                   | Simulación F| sí | guardados | medio     | técnica 2  |
                   Then podré iniciar  cualquier “<simulación>”  permitiendo practicar 
...
#Como estudiante en prácticas, quiero realizar simulaciones en VR para que pueda mejorar constantemente cada día.
        ...
        When realize una “<simulación>” en la plataforma,
      ...
      | María                   | Simulación F| sí  | guardados | medio | técnica 2 | 
        Then mi “<progreso>” y “<resultados>” se almacenan automáticamente , permitiéndole revisar mi “<rendimiento>” 
        And podre enfocarme en “<áreas de mejora>” específicas.
...
#Como estudiante en prácticas, quiero  tener acceso a un catálogo de simulaciones para que pueda practicar en diferentes situaciones en mi vida laboral.
         Scenario: Búsqueda del catálogo. 
              Given que el usuario accede al “<catálogo de simulaciones>”,
              When quiera practicar sus “<habilidades blandas>”, 
        ...
        | Catálogo B   | Liderazgo      | Simulaciones | Situación 2  | 
              Then se desplegará un “<menú>” con todas las “<posibles situaciones en la vida laboral>”. 
